    ...
    <div className="p-6 space-y-8 pt-12">
      <header className="flex justify-between items-center">
        <div>
          ...
          <h2 className="text-2xl font-bold text-white">Dein Free-Trial Status</h2>
        </div>
        <div className="w-10 h-10 rounded-full bg-brand-card border border-white/10 flex items-center justify-center">
